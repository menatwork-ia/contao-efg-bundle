...
//        $objDca->field = 'tl_form_field';
	...
	public function updateConfig($arrForms = null)
	{
		...
		$arrFiles = scan(TL_ROOT . '/vendor/menatwork/contao-efg-bundle/src/Resources/contao/dca', true);
		...
		foreach ($arrFiles as $strFile)
		{
			if (substr($strFile, 0, 3) == 'fd_')
			{
				...
				{
					$objFile = new \File('/vendor/menatwork/contao-efg-bundle/src/Resources/contao/dca/' . $strFile);
					$objFile->delete();
				}
			}
		}
		...
		$arrModLangs = scan(TL_ROOT . '/vendor/menatwork/contao-efg-bundle/src/Resources/contao/languages');
		...
		foreach ($arrModLangs as $strModLang)
		{
			...
			if (array_key_exists($strModLang, $arrLanguages))
			{
				...
				$strFile = sprintf('%s/vendor/menatwork/contao-efg-bundle/src/Resources/contao/languages/%s/%s.php', TL_ROOT, $strModLang, 'tl_efg_modules');
				...
				$objMod = new \File('/vendor/menatwork/contao-efg-bundle/src/Resources/contao/languages/'.$strModLang.'/modules.php');
		...
		if (is_array($arrForms) && !empty($arrForms))
		{
			foreach ($arrForms as $arrForm)
			{
				if (!empty($arrForm))
				{
					...
					$debugModus = \Config::get('debugMode');
                    \Config::set('debugMode', false);
					$objDca = new \File('/vendor/menatwork/contao-efg-bundle/src/Resources/contao/dca/fd_' . $strFormKey . '.php');
