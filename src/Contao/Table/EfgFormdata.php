...
class EfgFormdata extends \Backend
{
     ...
     * @param string $varFormKey specific form if called from MenAtWork\\EfgBundle\\Contao\\Module\\ModuleFormdataListing
     */
    function loadDCA(\DataContainer $dca, $varFormKey = '')
    {
        ...
        if ($varFormKey != '' && is_string($varFormKey))
        {
            if ($varFormKey != 'tl_formdata' )
            {
                ...
                {
                    $strFile = sprintf('%s/vendor/menatwork/contao-efg-bundle/src/Resources/contao/dca/%s.php', TL_ROOT, $strFileName);
