			...
			foreach ($result as $row)
			{
				...
				if ($intRowCounter == 1)
				{
					...
					foreach ($showFields as $k=>$v)
					{
						...
						elseif ($strMode=='xls')
						{
							...
							{
                                try {
                                    $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow($intColCounter, $intRowCounter, $strName);
                                    $spreadsheet->getActiveSheet()->getStyleByColumnAndRow($intColCounter, $intRowCounter)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
                                }catch(Exception $e) {
                                    //TODO Handle Exception
                                }
				...
				foreach ($showFields as $k=>$v)
				{
					...
					elseif ($strMode=='xls')
					{
						...
						{
						    try {
                                $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow($intColCounter, $intRowCounter, $strVal);
                            }catch (Exception $e) {
						        //TODO Handle Exception
                            }
