...
if (!empty($GLOBALS['TL_DCA']['tl_form_field']['fields']['type']['options']) && is_array($GLOBALS['TL_DCA']['tl_form_field']['fields']['type']['options']))
{
	// Field type efgLookupSelect
...
$GLOBALS['BE_FFL']['efgLookupOptionWizard']  = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgLookupOptionWizard';
$GLOBALS['BE_FFL']['efgLookupSelect']        = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupSelectMenu';
$GLOBALS['BE_FFL']['efgLookupCheckbox']      = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupCheckbox';
$GLOBALS['BE_FFL']['efgLookupRadio']         = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupRadio';
$GLOBALS['BE_FFL']['efgFormPaginator']       = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormPaginator';

// Add front end form fields
$GLOBALS['TL_FFL']['efgLookupSelect']        = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupSelectMenu';
$GLOBALS['TL_FFL']['efgLookupCheckbox']      = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupCheckbox';
$GLOBALS['TL_FFL']['efgLookupRadio']         = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormLookupRadio';
$GLOBALS['TL_FFL']['efgImageSelect']         = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormImageSelect';
$GLOBALS['TL_FFL']['efgFormPaginator']       = 'MenAtWork\\EfgBundle\\Contao\\Widgets\\EfgFormPaginator';
