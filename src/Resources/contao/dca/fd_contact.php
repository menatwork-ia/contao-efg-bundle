...
// last created on 2018-04-04 12:45:08 by saving form "Contact"



/**
 * Table tl_formdata defined by form "Contact"
 */
...
(
	...
	<div class="fd_row field_message"><div class="fd_label">Your Message: </div><div class="fd_value">%s </div></div>
		</div>',
			/*
			'label_callback'          => array('tl_fd_contact','getRowLabel')
			*/
		),
 ...
 * @package    Efg
 */
class tl_fd_contact extends \Backend
{
